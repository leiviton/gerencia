    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this.route.params
            ...
            _this.httpService.builder().view(params['id'], 'product')
                ...
                _this.product.subgroup_id = res.data.subgroup.data.id;
