    ...
    NewComponent.prototype.saveClient = function () {
        ...
        if (this.client.name == null || this.client.phone == null) {
            ...
            this.httpService.builder()
                ...
                console.log('cliente', _this.client);
