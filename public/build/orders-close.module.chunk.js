...
var EditComponent = (function () {
    ...
    EditComponent.prototype.openOrder = function () {
        ...
        var type_payment;
        var data_payment;
        var paymets = this.order.payment.data;
        var di = new Date();
        for (var i in paymets) {
...
var OrdersCloseComponent = (function () {
    ...
    OrdersCloseComponent.prototype.getTypesPayments = function () {
        var _this = this;
        this.httpService.setAccessToken();
        this.httpService.builder()
            .list({}, 'typepayment')
            .then(function (res) {
            _this.types_payments = res;
        });
    };
    OrdersCloseComponent.prototype.getClients = function () {
        var _this = this;
        this.httpService.setAccessToken();
        this.httpService.builder()
            .list({}, 'clients')
    ...
    OrdersCloseComponent.prototype.openReal = function () {
        this.hideModal('#rel');
        window.open('/#/relatorios/relatorio-pedidos-periodo', '_blank');
    };
    OrdersCloseComponent.prototype.report = function () {
        var _this = this;
        this.showLoading();
        if (this.pesquisa.inicio !== null && this.pesquisa.fim !== null) {
            var data = new Array();
    ...
    OrdersCloseComponent.prototype.reportXLS = function () {
        var _this = this;
        this.showLoading();
        if (this.pesquisa.inicio !== null && this.pesquisa.fim !== null) {
            var data = new Array();
            ...
            this.httpService.builder().list({}, "orders/report/xls?data[cliente]=" + this.pesquisa.cliente + "&data[inicio]=" + this.pesquisa.inicio +
                ...
                .then(function (res) {
                _this.hideLoading();
                _this.link_report = __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].server_url + '/printer/' + res + '.xls';
                if (res.length > 0) {
                    _this.notification.message('Sucesso', 'Relatorio gerado com sucesso', 'success');
                }
                else if (res.length == 0) {
